    ...
    <main className="legal-page container">
      ...
      <section className="legal-section">
        ...
        <p>
          ...
          mostrar el resultado orientativo del precio de la landing page. En esta versión no existe
          un formulario de registro, cuenta de usuario ni una base de datos propia asociada al uso
          de la calculadora.
        </p>
      </section>
      ...
      <section className="legal-section">
        ...
        <p>
          ...
          mantener la seguridad básica del servicio. Además, se realiza una medición agregada del
