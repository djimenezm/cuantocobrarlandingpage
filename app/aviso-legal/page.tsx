  ...
  return (
    <main className="legal-page container">
      ...
      <section className="legal-section">
        ...
        <p>
          Este sitio ofrece una calculadora orientativa para estimar cuanto cobrar por una landing
          ...
          directos y margen. La informacion se facilita con fines informativos y no sustituye el
      ...
      <section className="legal-section">
        ...
        <p>
          ...
          criterios simplificados de calculo. El titular no garantiza la ausencia de errores o
          desviaciones respecto al tiempo real del proyecto, a su complejidad efectiva o a tus
          condiciones fiscales, tecnicas o contractuales concretas, y no asume responsabilidad por
